...
public class ConexionCliente<R extends Registro<R, ?>>
    ...
    public ConexionCliente(BaseDeDatos<R, ?> bdd,
        ...
        super(bdd, enchufe);
        bdd.agregaEscucha((e, r1, r2) -> manejaEventos(e, r1, r2));
    ...
    private void manejaEventos(EventoBaseDeDatos evento,
        ...
        case REGISTRO_AGREGADO:
            enviaAlteracionRegistro(Mensaje.REGISTRO_AGREGADO,
                                    registro1);
            break;
        case REGISTRO_ELIMINADO:
            enviaAlteracionRegistro(Mensaje.REGISTRO_ELIMINADO,
                                    registro1);
            break;
...
ignorarEventos=false;
    ...
    @Override protected void manejaBaseDeDatos() {
     ...
     avisaEscuchas(EventoConexion.ERROR, "Error al cargar la base de datos");
           }
    }

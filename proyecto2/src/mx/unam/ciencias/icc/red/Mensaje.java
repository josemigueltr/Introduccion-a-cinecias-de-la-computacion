...
public enum Mensaje {
    ...
    public String toString() {
      switch (this) {
                 case BASE_DE_DATOS:        return MENSAJE +"BASE_DE_DATOS";
                 case REGISTRO_AGREGADO:    return MENSAJE + "REGISTRO_AGREGADO";
                 case REGISTRO_ELIMINADO:   return MENSAJE + "REGISTRO_ELIMINADO";
                 case REGISTRO_MODIFICADO:  return MENSAJE + "REGISTRO_MODIFICADO";
                 case DESCONECTAR:          return MENSAJE + "DESCONECTAR";
                 case DETENER_SERVICIO:     return MENSAJE + "DETENER_SERVICIO";
                 case ECO:                 return MENSAJE + "ECO";
                 case INVALIDO:            return MENSAJE + "INVALIDO";
                 default:
                         return "";
            }
